...
if store.time_hour = 8 {audio_play_sound(sfx_church_bells,1,false) with obj_lightmap lightmap_set_ambient(.55); if store.tut_bells = 0 {store.tut_bells=1 hud.chat_open = 1 hud.chat_text = "Survivors Guide\n\nHear those bells?\nEvery night the Church bells will ring as a warning when the larger hordes are coming into town.\nFind somewhere safe to shelter until daylight!"}}
