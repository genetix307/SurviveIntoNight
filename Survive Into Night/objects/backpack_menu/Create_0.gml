...
if survivalTipIndex = 6 {survivalTip = "The red marker on your map shows the area you’re currently at. The yellow marker shows where you’re current goal is located at."}
