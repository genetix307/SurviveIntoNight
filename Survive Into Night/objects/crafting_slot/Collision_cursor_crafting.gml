...
if my_id=5 {if store.chemicals >=3 and store.sugar >=2 {instance_create_depth(player.x,player.y,20,item_medicine) store.chemicals -=3 store.sugar -=2 craft_standard = 1}} 
