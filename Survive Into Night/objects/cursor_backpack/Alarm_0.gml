...
store.slot_item[backpack_menu.swap_slot_a] = store.slot_item[backpack_menu.swap_slot_b]
...
store.slot_item[backpack_menu.swap_slot_b] = store.slot_item[backpack_menu.swap_slot_a]
