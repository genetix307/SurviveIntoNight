if instance_number(upgrading_menu) <= 0 {instance_destroy() exit}
...
if !collision_point(x,y,upgrading_slot,false,true)
{
upgrading_menu.show_item_name = ""
upgrading_menu.show_item_description = ""
}